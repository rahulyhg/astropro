                        ...
                        <div class="box">
                            ...
                            <div class="box__main">
                                    ...
                                    <div class="box__row_image">
                                        <div class="modalInfo__elem">
                                            ...
                                            <div class="modalInfo__elem_image">
                                                <img src="img/life_map.png" class="img-fluid" alt="">
                                            </div>
                                            <a class="modalInfo__elem_button">Click to Preview</a>
                                        </div>
                                    </div>
                                    <div class="box__row_content">
                                        <p>A Life Map report contains secret details about you that no one else knows. It will completely explain who you are and why. Get yours now.</p>
                                        <form class="form">
                                ...
                                <div class="text-center">
                                    <a href="page_071.php" class="btn-cancel">No, I want to stay in the dark</a>
                                </div>
